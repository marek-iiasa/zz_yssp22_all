...
Sets
    ...
    map_tec_storage(node,tec,mode,storage_tec,mode2,level,commodity)              mapping of charge-discharging technologies to their respective storage container tec and level-commodity
