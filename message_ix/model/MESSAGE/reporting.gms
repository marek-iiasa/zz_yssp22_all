...
report_activity(node,tec,historical,time)$( map_tec(node,tec,historical) ) =
    sum((mode), historical_activity(node,tec,historical,mode,time) ) ;

report_activity(node,tec,year,time)$( map_tec(node,tec,year) ) =
